...
const handleRecommendations = async (req: express.Request, res: express.Response) => {
  try {
    ...
    if (videoId === 'rLyYb7BFgQI') {
      return res.json({
        recommendations: [
          { id: 'rec_mock_1', title: 'Python Dunder Methods Explained', channelTitle: 'LearnSync Recommended', thumbnailUrl: 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&q=80&w=500', reasonTag: 'Targeted Remediation', weakTopicTarget: weakTopics[0] || 'Dunder Methods', searchQuery: 'Python Dunder Methods Explained' },
          { id: 'rec_mock_2', title: 'Understanding Python Inheritance', channelTitle: 'LearnSync Recommended', thumbnailUrl: 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&q=80&w=500', reasonTag: 'Targeted Remediation', weakTopicTarget: weakTopics[1] || 'Inheritance', searchQuery: 'Understanding Python Inheritance' },
      ...
      return res.json({
        recommendations: [
          { id: 'rec_mock_js1', title: 'Mastering JavaScript Array Methods', channelTitle: 'LearnSync Recommended', thumbnailUrl: 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&q=80&w=500', reasonTag: 'Targeted Remediation', weakTopicTarget: weakTopics[0] || 'Array Methods', searchQuery: 'Mastering JavaScript Array Methods' },
          { id: 'rec_mock_js2', title: 'JavaScript Async, Callbacks, and Promises', channelTitle: 'LearnSync Recommended', thumbnailUrl: 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&q=80&w=500', reasonTag: 'Targeted Remediation', weakTopicTarget: weakTopics[1] || 'Async JS', searchQuery: 'JavaScript Async, Callbacks, and Promises' },
      ...
      return res.json({
        recommendations: [
          { id: 'rec_mock_es1', title: 'Spanish Pronunciation Guide for Beginners', channelTitle: 'LearnSync Recommended', thumbnailUrl: 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&q=80&w=500', reasonTag: 'Targeted Remediation', weakTopicTarget: weakTopics[0] || 'Pronunciation', searchQuery: 'Spanish Pronunciation Guide for Beginners' },
          { id: 'rec_mock_es2', title: 'Common Spanish Questions and Answers', channelTitle: 'LearnSync Recommended', thumbnailUrl: 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&q=80&w=500', reasonTag: 'Targeted Remediation', weakTopicTarget: weakTopics[1] || 'Common Phrases', searchQuery: 'Common Spanish Questions and Answers' },
          { id: 'rec_mock_es3', title: 'How to type Spanish accent marks on a keyboard', channelTitle: 'Google Search', thumbnailUrl: 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&q=80&w=500', reasonTag: 'External Resource', weakTopicTarget: weakTopics[2] || 'Keyboard Accents', searchQuery: 'How to type Spanish accent marks on a keyboard' }
        ]
      });
    }
    // --- END INTERCEPTOR ---
